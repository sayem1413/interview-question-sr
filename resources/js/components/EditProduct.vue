            ...
            <div class="col-md-6">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body border">
                        ...
                        <input class="multiple-image-upload"
                            accept="image/*" type="file"
                            multiple
                            ref="productImage"
                            name="productImage"
                            @change="addProductImage($event)"
                        />
                    </div>
                    <br/>
                    <span class="row m-2">
                        <div v-for="(pImage, index) in images" :key="index" class="col-sm-4">
                            <div class="card text-center p-2 m-2">
                                <img :src="pImage.file_path" class="img-fluid m-2" />
                            </div>
                        </div>
                    </span>
                </div>
    ...
    methods: {
        ...
        addProductImage(event) {
            ...
            for (index = 0; index < files.length; index++ ) {
                ...
                if (file && file.size > 9*1024*1024*5) {
                    return;
                }
                ...
                if(file && file.size <= 9*1024*1024*5) {
                    ...
                    formData.append("productImage", this.$refs.productImage.files[index]);
                    axios.post(url, formData, {
                        ...
                        this.images.push(
                            {
                                id:response.data.productImage.id,
